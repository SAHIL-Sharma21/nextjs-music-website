        ...
        <footer className="bg-black text-gray-400 p-12">
            <div className="max-w-6xl mx-auto grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-8 px-4 sm:px-6 lg:px-8">
                <div>
                    ...
                    <p className="mb-4">Music school primer insution dedicated to teaching the art and science of music. We nurtue talent from the ground up, fostering a vibrant comunity of musicians.</p>
                </div>
                <div>
